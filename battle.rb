...
class Battle
  ...
  def turn_order
    until @player.pokemon.fainted? || @bot.pokemon.fainted?
      ...
      first_move = if compare_priorities
                     if @player_selected_mov[:priority] > @bot_mov[:priority]
                       [@player,
                        @player_selected_mov]
                     else
                       [@bot, @bot_mov]
                     ...
                     [[@player, @player_selected_mov], [@bot, @bot_mov]].sample
                   end
  ...
  def display_damage(defender, _attacker)
